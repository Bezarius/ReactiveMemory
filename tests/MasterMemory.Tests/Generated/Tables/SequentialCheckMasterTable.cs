...
namespace ReactiveMemory.Tests.Tables
{
   public sealed partial class SequentialCheckMasterTable : TableBase<SequentialCheckMaster>, ITableUniqueValidate
   {
        ...
        {
            return new ReactiveMemory.Meta.MetaTable(typeof(SequentialCheckMaster), typeof(SequentialCheckMasterTable), "sequantial_master",
                new ReactiveMemory.Meta.MetaProperty[]
                {
                    new ReactiveMemory.Meta.MetaProperty(typeof(SequentialCheckMaster).GetProperty("Id")),
                    new ReactiveMemory.Meta.MetaProperty(typeof(SequentialCheckMaster).GetProperty("Cost")),
                },
