...
namespace MasterMemory
{
    ...
    public class ChangesConveyor
    {
        ...
        public IChangesQueue<TElement> GetQueue<TElement>()
        {
            ...
            {
                _dbChangesPublishers.Add(typeId, new ChangesQueue<TElement>(this));
            }
    ...
    public class ChangesQueue<TEntity> : IDbChangesPublisher, IChangesQueue<TEntity>
    {
        ...
        public ChangesQueue(ChangesConveyor changesConveyor)
        {
    ...
    public struct EntityChange<TEntity>
    {
    ...
    {
        public readonly ChangesConveyor ChangesConveyor = new ChangesConveyor();
        ...
        public MemoryDatabaseBase(byte[] databaseBinary, bool internString = true,
            IFormatterResolver formatterResolver = null, int maxDegreeOfParallelism = 1)
        {
