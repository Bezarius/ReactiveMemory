...
namespace ReactiveMemory.Tests.Tables
{
   public sealed partial class TestMasterTable : TableBase<TestMaster>, ITableUniqueValidate
   {
        ...
        {
            return new ReactiveMemory.Meta.MetaTable(typeof(TestMaster), typeof(TestMasterTable), "TestMaster",
                new ReactiveMemory.Meta.MetaProperty[]
                {
                    new ReactiveMemory.Meta.MetaProperty(typeof(TestMaster).GetProperty("TestID")),
                    new ReactiveMemory.Meta.MetaProperty(typeof(TestMaster).GetProperty("Value")),
                },
