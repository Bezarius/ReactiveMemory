...
namespace ReactiveMemory.Test2.Tables
{
   public sealed partial class UserLevelTable : TableBase<UserLevel>, ITableUniqueValidate
   {
        ...
        {
            return new ReactiveMemory.Meta.MetaTable(typeof(UserLevel), typeof(UserLevelTable), "UserLevel",
                new ReactiveMemory.Meta.MetaProperty[]
                {
                    new ReactiveMemory.Meta.MetaProperty(typeof(UserLevel).GetProperty("Level")),
                    new ReactiveMemory.Meta.MetaProperty(typeof(UserLevel).GetProperty("Exp")),
                },
