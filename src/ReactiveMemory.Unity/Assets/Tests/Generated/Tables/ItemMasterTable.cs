...
namespace ReactiveMemory.Tests.Tables
{
   public sealed partial class ItemMasterTable : TableBase<ItemMaster>, ITableUniqueValidate
   {
        ...
        {
            return new ReactiveMemory.Meta.MetaTable(typeof(ItemMaster), typeof(ItemMasterTable), "item_master",
                new ReactiveMemory.Meta.MetaProperty[]
                {
                    new ReactiveMemory.Meta.MetaProperty(typeof(ItemMaster).GetProperty("ItemId")),
                },
