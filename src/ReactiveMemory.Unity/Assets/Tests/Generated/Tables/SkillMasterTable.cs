...
namespace ReactiveMemory.Tests.Tables
{
   public sealed partial class SkillMasterTable : TableBase<SkillMaster>, ITableUniqueValidate
   {
        ...
        {
            return new ReactiveMemory.Meta.MetaTable(typeof(SkillMaster), typeof(SkillMasterTable), "skillmaster",
                new ReactiveMemory.Meta.MetaProperty[]
                {
                    new ReactiveMemory.Meta.MetaProperty(typeof(SkillMaster).GetProperty("SkillId")),
                    new ReactiveMemory.Meta.MetaProperty(typeof(SkillMaster).GetProperty("SkillLevel")),
                    new ReactiveMemory.Meta.MetaProperty(typeof(SkillMaster).GetProperty("AttackPower")),
                    new ReactiveMemory.Meta.MetaProperty(typeof(SkillMaster).GetProperty("SkillName")),
                    new ReactiveMemory.Meta.MetaProperty(typeof(SkillMaster).GetProperty("Description")),
                },
