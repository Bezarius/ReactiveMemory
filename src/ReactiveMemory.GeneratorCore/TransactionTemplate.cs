...
namespace ReactiveMemory.GeneratorCore
{
    ...
    for (var i = 0; i < GenerationContexts.Length; i++)
    {
        var item = GenerationContexts[i];
    ...
    for (var j = 0; j < GenerationContexts.Length; j++)
    {
        var item = GenerationContexts[j];
